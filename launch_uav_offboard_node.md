...
# 进入自检
ros2 topic pub --once /main_task_fsm/task_states status_interfaces_pkg/msg/TaskFSM "{main_task_state: 10}"

# 自检成功后进入 UAV_HOLD
ros2 topic pub --once /main_task_fsm/task_states status_interfaces_pkg/msg/TaskFSM "{main_task_state: 11}"
